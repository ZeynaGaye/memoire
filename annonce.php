...
require_once('connexiondb.php');
    ...
    if (isset($_POST['mess'])){
        $sms=$_POST['mess'];
        $tontine=$_SESSION['idTontine'];
        $user= $_SESSION['id'];
        
        $req="insert into annonce(annonce, tontine_id, user_id) values(?,?,?)";
        $res=$pdo->prepare($req);
        $res->execute( array($sms,$tontine,$user));
    ...
    <div class="row" >
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="well profile">
                ...
                <h3 class="name pull-left clearfix"> Annonce</h3>
