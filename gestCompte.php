...
<div class="container-fluid">
    ...
    <div class="navbar-header">
        ...
        <a href="accueilAdmin.php" class="navbar-brand">Retour</a>
...
<section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h2 class="section-heading text-uppercase"  id = "bienv"></h2>
                ...
                <div class="row text-center ">
                    <div class="col-md-4">
                        <!-- <span class="fa-stack fa-4x"> -->
                           ...
                           <a href="compte.php"><img src="assets/img/OM.JPG" alt="" style = "width:70%;"></a>
                        <!-- </span> -->
                    ...
                    <div class="col-md-4">
                        <!-- <span class="fa-stack fa-4x"> -->
                            <!-- <i class="fas fa-circle fa-stack-2x text-primary"></i> -->
                            <a href="compte.php"> <img src="assets/img/wave.PNG" alt=""> </a>
